...
import { isEventOver } from '../lib/dayUtils'
  ...
  return (
    <div className="min-h-dvh pb-nav-safe page-enter">
      <div className="bg-rex-card border-b border-rex-border px-4 py-4 pt-safe">
        <div className="max-w-lg mx-auto">
          ...
          <p className="text-gray-500 text-sm">
            {eventEnded ? 'O evento foi encerrado' : 'Peça a um colega para escanear!'}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-8 flex flex-col items-center">
        {eventEnded ? (
          <div className="bg-rex-card border border-rex-border rounded-2xl p-6 text-center max-w-xs">
            <p className="text-3xl mb-3">🦖</p>
            <p className="text-gray-300 text-sm">
              Os check-ins foram encerrados às 15h20. O QR Code de networking não está mais disponível.
            </p>
          </div>
        ) : (
          <>
